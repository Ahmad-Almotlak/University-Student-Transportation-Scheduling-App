...
class _LoadImageState extends State<LoadImage> {
  ...
  Future<void> sendData() async {
    final url = Uri.parse('http://10.2.0.2:3000/my-python-function');
  ...
  Future<void> end_connection() async {
    ...
    if (response.statusCode == 200) {
      ...
      setState(() {
        ...
        if (responseData['res'] != null && responseData['res'].isNotEmpty && responseData['res']!='python, I received this: enter correct image') {
          ...
          for (int i = 0; i < days.length; i++) {
            ...
            const SnackBar(content: Text('The image uploaded successfully')));
                } else {
